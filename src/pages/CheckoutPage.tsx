    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-6">
        <div className="text-center max-w-md animate-scale-in">
          ...
          <p className="text-sm text-muted-foreground font-mono mb-2">Order #FK-{Math.random().toString(36).substr(2, 8).toUpperCase()}</p>
            ...
            <div className="lg:col-span-3">
              ...
              <div className="mb-10">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className="flex items-center justify-center gap-2 h-12 bg-foreground text-background rounded font-mono text-sm hover:opacity-90 transition-opacity active:scale-[0.97]"
                  >
              ...
              <form onSubmit={handlePlaceOrder} className="space-y-6">
                <div>
                  ...
                  <Input placeholder="freak@example.com" className="bg-surface border-border font-mono" required />
                </div>
                <div>
                  ...
                  <div className="space-y-3">
                    <div className="grid grid-cols-2 gap-3">
                      <Input placeholder="First name" className="bg-surface border-border font-mono" required />
                      <Input placeholder="Last name" className="bg-surface border-border font-mono" required />
                    </div>
                    <Input placeholder="Address" className="bg-surface border-border font-mono" required />
                    <div className="grid grid-cols-3 gap-3">
                      <Input placeholder="City" className="bg-surface border-border font-mono" required />
                      <Input placeholder="State" className="bg-surface border-border font-mono" required />
                      <Input placeholder="ZIP" className="bg-surface border-border font-mono" required />
                    </div>
                  </div>
                </div>
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <Input placeholder="CVC" className="bg-surface border-border font-mono" required />
                    </div>
                  </div>
                </div>
                <Button variant="neonLime" size="xl" className="w-full" type="submit">
